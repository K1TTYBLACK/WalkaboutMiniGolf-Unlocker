...
class App(ttk.Frame):
    ...
    def select_file(self):
        ...
        self.profile_name.config(
            text=f'{username}' if username else "UNKNOWN")
    ...
    def setup_widgets(self):
        ...
        profile_frame = ttk.LabelFrame(
            self, text="Profile", padding=(20, 10))
        ...
        unlocking_frame = ttk.LabelFrame(
            self, text="Unlocker", padding=(20, 10))
        unlocking_frame.grid(row=5, column=0, padx=20, pady=20, sticky="nsew")

        self.unlock_balls_check = ttk.Checkbutton(
            unlocking_frame, text="Unlock balls", variable=self.unlock_balls, cursor="X_cursor"
        )
        ...
        self.unlock_putters_check = ttk.Checkbutton(
            unlocking_frame, text="Unlock putters", variable=self.unlock_putters, cursor="X_cursor"
        )
        ...
        self.proceed_unlock.grid(row=2, column=0, columnspan=2,
